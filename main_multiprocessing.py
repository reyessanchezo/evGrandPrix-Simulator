...
def run_motor(serial_port, speeds) -> None:
    ...
    with VESC(serial_port=serial_port) as motor:
        try:
            ...
            thread = multiprocessing.Process(target=read_measurements, args=(motor,))
            thread.daemon = True
            thread.start()
...
if __name__ == "__main__":
    ...
    motor1 = multiprocessing.Process(
        target=run_motor,
        args=(
            s2,
            rpm,
    ...
    motor2 = multiprocessing.Process(target=test_dyno, args=(s2,))
